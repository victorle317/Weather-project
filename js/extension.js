    ...
    switch (name) {
        ...
        item={
            ...
            suggestWeather : {
                ...
                recommend:"Mặc áo chống nắng,dùng kem chống nắng,hạn chế tiếp xúc lâu dài với nắng gắt",
            }
        }
            return item;
        }
        ...
        case "Overcast": {
            ...
            nameIcon : "icon-8",
            suggestWeather : {
                suggestFood:"Khoai sọ kho thịt,rau cải xào dầu hào,canh gà chua nấu sườn,sữa chua xoàixoài",
        ...
        case "Patchy rain possible": {
            item={
            nameWeather : "Có khả năng mưa vài nơi",
            nameIcon : "icon-9",
            suggestWeather : {
                suggestFood:"Khoai lang nướng,đậu hũ non chiên giòn,canh sườn hạt sen,kho quẹt,ốc hấp",
        ...
        case "Patchy snow possible": {
            ...
            nameIcon : "icon-13",
            suggestWeather : {
                suggestFood:"Súp khoai tây hầm thịt bò,cháo hải sản,ngao xào cay,bò hầm rượu vang",
        ...
        case "Thundery outbreaks possible": {
            ...
            nameIcon : "icon-12",
            suggestWeather : {
                suggestFood:"Đậu sốt cà chua,cá kho tộ,canh cải nấu thịt bằm,bánh mì sốt vang",
        ...
        case "Blizzard": {
            ...
            nameIcon : "icon-14",
            suggestWeather : {
                suggestFood:"Canh khoai sọ nâu với xương,trứng vịt lộn hầm ngải cứu thuốc bắc,cơm thố",
        ...
        case "Fog": {
            ...
            suggestWeather : {
                ...
                recommend:"Ra đường cần chú ý quan sát,đi chậm do tầm nhìn rất hạn chế"
    ...
    return item;
        ...
        case "Freezing fog": {
            ...
            suggestWeather : {
                ...
                recommend:"Cần mặc ấm,chú ý quan sát khi ra ngoài đường do tầm nhìn bị hạn chế"
            }
        }
    return item;
    }
        ...
        case "Light drizzle": {
            ...
            suggestWeather : {
                ...
                suggestAddress:"Gấu rủ đi đâu thì đi cùng,nếu không có gấu tốt nhất là ở nhà",
        ...
        case "Freezing drizzle": {
            ...
            suggestWeather : {
                ...
                suggestAddress:"Đi chơi cùng với người yếu,chứ mà tầm này ra đường thì cẩu lương lắm",
        ...
        case "Heavy freezing drizzle": {
            ...
            suggestWeather : {
                ...
                suggestAddress:"Địa điểm chân ái nhất là ở nhà nếu bạn khong phải đi là hoặc đi học", 
        ...
        case "Light rain": {
            ...
            nameIcon : "icon-9",
            suggestWeather : {
                suggestFood:"Khoai tây chiên,gà rán,bún đậu mắm tôm,măng tre tươi nấu xương heo",
        ...
        case "Heavy rain at times": {
            ...
            nameIcon : "icon-10",
            suggestWeather : {
                suggestFood:"Đậu phộng rang muối,thịt ba chỉ xào mắm ruốc,dưa cải xào tóp mỡ,đậu phụ chiên trứng",
        ...
        case "Heavy rain": {
            ...
            nameIcon : "icon-10",
            suggestWeather : {
                suggestFood:"Thịt ba chỉ xào măng,gà kho gừng,canh chua cá,canh khaoi sọ nấu sương",
        ...
        case "Light sleet": {
            ...
            nameIcon : "icon-13",
            suggestWeather : {
                suggestFood:"Kho quẹt,nem rán,thịt rim mắm sa tế,cá cơm rim tỏi ớtớt",
        ...
        case "Moderate or heavy sleet": {
            ...
            nameIcon : "icon-14",
            suggestWeather : {
                suggestFood:"Cá trắm kho riềng,súp khoai tây hầm thịt bò,cháo hải sản,ngao xào caycay",
        ...
        case "Patchy light snow": {
            ...
            nameIcon : "icon-13",
            suggestWeather : {
                suggestFood:"Bò hầm rượu vang,chè đậu đỏ hạt sen,bánh củ cải,cá kho tộ",
                suggestAddress:"Ở nhà cho lành",
                recommend:"Giữ ấm cho cơ thể"
            }
        }
        ...
        case "Light snow": {
            ...
            nameIcon : "icon-13",
            suggestWeather : {
                suggestFood:"Đậu số cà chua,thịt kho dừa,canh cải nấu với thịt bămbăm",
        ...
        item={
            ...
            nameIcon : "icon-13",
            suggestWeather : {
                suggestFood:"Bánh mì sốt vang,bún bò huế,ngô xào thịt băm,súp gà nấm hương,canh khoai sọ nấu với xương",
